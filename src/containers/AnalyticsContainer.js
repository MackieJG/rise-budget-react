...
const AnalyticsContainer = () => {
    ...
    return (
        ...
        <form>
            ...
            <select id="category" name="category" onChange={(event) => handleCategoryChange(event.target.value)}>
            ...
            <select id="date" name="date" onChange={(event) => handleDateChange(event.target.value)}>
